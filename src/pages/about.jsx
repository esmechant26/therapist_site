...
function About() {
  return (
    <section className="section-margin">
      <div className="card card-padding-2 servicios-hero">
      ...
      <div className="card card-padding-2 about-body">
        ...
        <p>
          ...
          interventions, and I use these once in a while as they are evidence-based interventions. When I do incorporate techniques from these last three modalities, I like to combine the
      ...
      <div className="card card-padding-2 about-the-practice">
