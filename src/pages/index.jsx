...
// import heroImage from "../assets/index-anna-shvets.jpg";
      ...
      <section className="section-margin">
        <div className="card card-padding-2">
          ...
          {/* <section className="home-hero">
            <img src={heroImage} alt="Two hands reaching out to eachother" className="home-hero-image" />
            <span className="home-hero-credit">Image by Anna Shvets</span>
          </section> */}
          ...
          <p className="section-copy">
            Relational Constellations including, people on non-monogamous relationships, polycules, Monogamous couples, friends, and adults wanting to improve their relationships with their parents
            who need support to resolve issues that are affecting the relationship(s).
          </p>
          <p className="section-copy">
            Individuals seeking psychedelic and/or spiritual integration. Have you had an experience in an altered state of consciousness that you're still not quite sure what to make of? Therapy can
            be a great place to process these experiences. Altered states of consciousness can include states influenced by: substances, spiritual awakenings, or near-death-experiences. Specializing
            in integration for Ketamine Assisted Therapy (KAT), this is a great option if you are already connected to a prescriber for your medicine. Please note that for appointments centered around
